...
namespace SmartBot.Mulligan
{
    ...
    {
        private static string _name = "Pirate Warrior Mulligan v1.1";
        private string _log = "\r\n---" + _name + "---\r\n";
        ...
        public List<Card.Cards> HandleMulligan(List<Card.Cards> choices, Card.CClass opponentClass, Card.CClass ownClass)
        {
            ...
            Define(Defs.One, Cards.NZothsFirstMate, Cards.SouthseaDeckhand);
            Define(Defs.Two, Cards.BloodsailRaider, Cards.FieryWarAxe);
